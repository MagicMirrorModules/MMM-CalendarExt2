...
| slotTitleFormat      | String Or Object        | "MM/DD"                                 | -                         | Set slot title by date. formatter of `.format()` of `Day.js` or object of `.calendar()` of `Day.js` (calendar plugin)                                                                                                                         |
...
| skipItems            | Integer                 | 30                                      | -                         | How many items should be skipped (e.g. cause they already display in another column).                                                                                                                                                         |
...
| weekStart            | Integer                 | 0                                       | 1                         | First day of the week. `1` = Monday (ISO 8601, default), `0` = Sunday (US/Canada convention). Affects `isSameWeek` comparisons, week-number CSS classes (`week_N`), and the column layout of `view:week` / `view:month`.                      |
...
| iconMap              | Object                  | {}                                      | `{Work:"noto-briefcase"}` | Assign icons to events by category name. See [Filtering and Sorting](../Filtering-and-Sorting.md)                                                                                                                                             |
